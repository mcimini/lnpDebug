...
type proof =
  ...
  | NoOp
  | Skip
  | Case of comment * lnp_name * lnp_name 
  ...
  | Apply of comment * lnp_name * lnp_name * lnp_name list * (var * var) option
  | Backchain of comment * lnp_name 
  | If of comment * evaluatedExpression * proof * proof
  | ForEachProof of comment * var * evaluatedExpression * proof
  | Seq of proof * proof
